...
// Function to get the last inserted comment_id
...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        $stmt = $conn->prepare("SELECT spots.place_name, spots.place_image, comments.comment_id, user.login_user, comments.comment_text, comments.comment_image, ratings.rating_value
            FROM spots
